...
public class CreateIssueWindow extends BaseJiraPage{
    ...
    @SneakyThrows
    public void selectIssueType (String visibleText) {
//        WebElement issueType = driver().findElement(issueTypeButton);
//        Select issue = new Select(issueType);
//        issue.selectByVisibleText(visibleText);
...
//        driverWait().until(ExpectedConditions.elementToBeClickable(issueTypeButton)).click();
        WebElement priorityField = driver().findElement(issueTypeLabel);
